...
$mpl = query("SELECT * FROM mapel WHERE kode =$kode")[0];
...
<div class="container d-flex justify-content-center">
    <div class="col-lg-6 mt-lg-5">
        <form action="" method="POST">
                <h1 class="text-center mb-5">Edit Mapel Guru</h1>
                <div class="mb-3">
                    <label for="kode" class="form-label">Kode</label>
                    <input type="text" class="form-control" id="kode" name="kode" value="<?=$mpl["kode"]?>">
                </div>
                <div class="mb-3">
                    <label for="namamapel" class="form-label">Nama Mapel</label>
                    <input type="text" class="form-control" id="namamapel" name="namamapel"value="<?= $mpl["namamapel"]?>">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="guru">GURU</label>
                    <input type="text" class="form-control" id="guru" name="guru"value="<?= $mpl["guru"]?>">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="GURU_nip">NIP</label>
                    <input type="text" class="form-control" id="GURU_nip" name="GURU_nip" value="<?= $mpl["GURU_nip"]?>">
                </div>
                    <input type="hidden" name="NILAI_id" value="<?= $mpl["NILAI_id"]?>">

...
<section class="jumbotron text-center mt-lg-5">
        ...
        <p class="lead">Halo <b><?php echo $_SESSION['username']; ?></b> Anda telah login sebagai <b><?php echo $_SESSION['level']; ?></b>.</p>
        <a class="btn btn-primary text-decration-none text-white" href="logout.php">LOGOUT</a>
</section>
...
<h1 class="mt-5 mb-5">Dafar Siswa </h1>
    <div class="col-lg-8">
        <table class="table table-responsive table-bordered" id="tabel-siswa" >
            ...
            <button class=" btn btn-primary "> <a class="text-white text-decoration-none" href="insert/insertSiswa.php">Tambah Data</a></button>
        </div>
    </section>
    <hr>
<section id="nilai">
        ...
        <table class="table table-responsive table-bordered" id="tabel-siswa" >
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div>
                                <a class="text-decoration-none text-danger" href="delete/deleteNilai.php?id=<?= $row['id'];?>">Hapus</a> | <a href="Edit/EditNilai.php?id=<?=$row['id']?>">Edit</a>      
                            </div>
                    </td>
                </tr>
                <?php $i++?>
            ...
            <button class=" btn btn-primary "> <a class="text-white text-decoration-none" href="insert/insertNilai.php">Tambah Data</a></button>
        </div>
    </section>
    <hr>
    <section id="mapel">
    ...
    <div class="col-lg-8">
        <table class="table table-responsive table-bordered" id="tabel-mapel" >
                ...
                <tbody>
                    ...
                    <td>
                            <div>
                                <a href="delete/deleteMapel.php?kode=<?= $row['kode'];?>">Hapus</a> | <a href="Edit/EditMapel.php?kode=<?=$row['kode']?>">Edit</a>
                            </div>
                    </td>
                </tr>
                <?php $i++?>
        ...
        <button class=" btn btn-primary "> <a class="text-white text-decoration-none" href="insert/insertMaple.php">Tambah Data</a></button>
        </div>          
    </section>
    ...
    <div class="col-lg-8">
        <table class="table table-responsive table-bordered" id="tabel-mapel" >
                ...
                <tbody>
                    ...
                    <td>    
                            <div>
                                <a href="delete/deleteGuru.php?nip=<?= $row["nip"]?>">Hapus</a> |        
                                <a href="Edit/EditGuru.php?nip=<?=$row['nip']?>">Edit</a>           
                            </div>
                    </td>
                </tr>
                <?php $i++?>
            ...
            <button class=" btn btn-primary "> 
                <a class="text-white text-decoration-none" href="insert/insertGuru.php">Tambah Data</a> 

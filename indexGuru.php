...
<h1 class="mt-5 mb-5">Dafar Siswa </h1>
    <div class="col-lg-8">
        <table class="table table-responsive table-bordered" id="tabel-siswa" >
            ...
            <button class=" btn btn-primary "> <a class="text-white text-decoration-none" href="insertGuru/insertSiswa.php">Tambah Data</a></button>
        </div>
    </section>
    <hr>
<section id="nilai">
<h1 class="mb-5 mt-5">Daftar Nilai</h1>
    <div class="col-lg-8">
        <table class="table table-responsive table-bordered" id="tabel-siswa" >
            ...
            <button class=" btn btn-primary "> <a class="text-white text-decoration-none" href="insertGuru/insertNilai.php">Tambah Data</a></button>
        </div>
    </section>
    <hr>
    <section id="mapel">

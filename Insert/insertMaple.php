    ...
    <div class="col-lg-6 mt-lg-5">
        <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="GURU_nip" name="GURU_nip">
                </div>
                <div class="mb-3">
                    <label class="form-label" for="NILAI_id">Nilai</label>
                    <input type="number" class="form-control" id="NILAI_id" name="NILAI_id">
                </div>
